        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-semibold mb-4">System Clients</h3>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white border border-gray-300">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-300">{{ $client->name }}</td>
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-300">{{ $client->email }}</td>
