        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-semibold mb-4">Service Providers</h3>
                        ...
                        <table class="min-w-full bg-white border border-gray-300">
                            <thead>
                                <tr>
                                    ...
                                    <th class="px-6 py-3 border-b border-gray-300 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Status</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-300">{{ $provider->name }}</td>
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-300">{{ $provider->email }}</td>
