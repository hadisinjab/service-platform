                ...
                <div class="p-6">
                                    ...
                                    @foreach($orders as $order)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <a href="{{ route('provider.order.details', $order->id) }}" class="text-blue-600 hover:text-blue-900 mr-3">View Details</a>
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <p class="text-gray-500 mb-6">When clients book your services, their orders will appear here.</p>
                        </div>
                    @endif
                </div>
            </div>
