            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-8">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="{{ route('provider.orders') }}" class="text-blue-600 hover:text-blue-800">View All</a>
                    </div>
                                    ...
                                    @foreach($recentOrders as $order)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <a href="{{ route('provider.order.details', $order->id) }}" class="text-blue-600 hover:text-blue-900">View Details</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                    ...
                    @else
                        <div class="text-center py-8">
                            <div class="text-gray-500 mb-4">No orders yet</div>
                            <p class="text-gray-600">When clients book your services, their orders will appear here.</p>
                        </div>
                    @endif
                </div>
            </div>
